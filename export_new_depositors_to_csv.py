...
SOURCE_TABLE = "new_depositors"
ORDER_COLUMN = "unique_code"
YEAR_COLUMN = "first_deposit_date"
BATCH_SIZE = 20000
OUTPUT_DIR = "exports"
OUTPUT_PREFIX = "new_depositors_export"

print("=" * 70)
print("REDSHIFT TO CSV EXPORT - NEW DEPOSITORS (per tahun)")
print("=" * 70)
