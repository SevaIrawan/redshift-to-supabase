...
def load_config(config_path: str = "sync_config.json") -> dict:
    """
...
def main():
    ...
    SOURCE_TABLE = config.get("source_table", "rs_blue_whale_usc")
    ...
    print("=" * 70)
    print("SYNC BLUE WHALE USC - RECENT DAYS (AUTO DETECT)")
    print("=" * 70)
