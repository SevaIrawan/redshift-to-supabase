"""
Sync rs_blue_whale_myr → blue_whale_myr (Supabase, H-2) dengan kolom tambahan:
...
def main():
    ...
    print("=" * 60)
    print(
        f"rs_to_myr: Sync rs_* → blue_whale_* (MYR) + traffic/FTD — "
    ...
    log_path_csv = LOGS_DIR / f"rs_to_myr_{ts}.csv"
