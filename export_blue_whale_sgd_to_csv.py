...
SOURCE_TABLE = "blue_whale_sgd"             # ganti kalau perlu
ORDER_COLUMN = "unique_key"                 # pastikan kolom ini ada di Redshift
YEAR_COLUMN = "year"                        # ganti sesuai kolom tahun/tanggal yang ada
BATCH_SIZE = 20000                          # jumlah row per batch
OUTPUT_DIR = "exports"
OUTPUT_PREFIX = "blue_whale_sgd_export"

print("=" * 70)
print("REDSHIFT TO CSV EXPORT - SGD (per tahun)")
print("=" * 70)
