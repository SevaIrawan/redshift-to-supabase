"""
Sync rs_blue_whale_sgd → blue_whale_sgd (Supabase, H-2) dengan kolom tambahan:
...
def main():
    ...
    print("=" * 60)
    print(
        f"rs_to_sgd: Sync rs_* → blue_whale_* (SGD) + traffic/FTD — "
    ...
    log_path_csv = LOGS_DIR / f"rs_to_sgd_{ts}.csv"
